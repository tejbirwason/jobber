...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small tj - Page \thepage{} of \pageref*{LastPage}}
...
\newenvironment{threecolentry}[3][]{
    \onecolentry
    \def\thirdColumn{#3}
    \setcolumnwidth{0.8 cm, \fill, 4 cm}
    \begin{paracol}{3}
    ...
    \section{Publications}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \mbox{Albert Smith}, \mbox{\textbf{\textit{tj}}}, \mbox{Jane Derry}, \mbox{Harry Tom}, \mbox{Frodo Baggins}
                \vspace{0.05 cm}
